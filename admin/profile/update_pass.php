...
<div class="lg:py-6  mt-7 lg:mt-0 transition-all duration-1000 ease  text-center md:text-left ml-[14%] mr-[5%]"
    id="mainarea">
    <h1 class="text-xl font-bold text-[#061638]">Change Your Password</h1>
    ...
    <div class="w-[96%] border mx-12 shadow bg-[#F9F5F6] rounded-xl">
        <div class="px-10 py-10">
            <form action="change_pass.php" class="w-full" method="POST">
                ...
                <div class="my-2">
                    <label for="old_password" class="text-black text-xl font-bold">Old Password</label>
                    <input type="password" class="border-none outline-none shadow py-2 px-4 block w-full rounded-xl my-2"
                        id="old_password" name="old_password" value="<?php echo isset($_SESSION['old_data']['old_password']) ? $_SESSION['old_data']['old_password'] : ''; ?>">
                    <?php if (isset($_SESSION['errors']['old_password'])): ?>
                        <span class="block text-red-600"><?php echo $_SESSION['errors']['old_password'].'*'; ?></span>
                    <?php endif; ?>     
                </div>
                <div class="my-2">
                ...
                <div class="my-4">
                    <input type="submit" name="pass" value="Update"
